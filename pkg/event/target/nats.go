...
const (
	...
	EnvNATSEnable        = "OBSTOR_NOTIFY_NATS_ENABLE"
	EnvNATSAddress       = "OBSTOR_NOTIFY_NATS_ADDRESS"
	EnvNATSSubject       = "OBSTOR_NOTIFY_NATS_SUBJECT"
	EnvNATSUsername      = "OBSTOR_NOTIFY_NATS_USERNAME"
	EnvNATSPassword      = "OBSTOR_NOTIFY_NATS_PASSWORD"
	EnvNATSToken         = "OBSTOR_NOTIFY_NATS_TOKEN"
	EnvNATSTLS           = "OBSTOR_NOTIFY_NATS_TLS"
	EnvNATSTLSSkipVerify = "OBSTOR_NOTIFY_NATS_TLS_SKIP_VERIFY"
	EnvNATSPingInterval  = "OBSTOR_NOTIFY_NATS_PING_INTERVAL"
	EnvNATSQueueDir      = "OBSTOR_NOTIFY_NATS_QUEUE_DIR"
	EnvNATSQueueLimit    = "OBSTOR_NOTIFY_NATS_QUEUE_LIMIT"
	EnvNATSCertAuthority = "OBSTOR_NOTIFY_NATS_CERT_AUTHORITY"
	EnvNATSClientCert    = "OBSTOR_NOTIFY_NATS_CLIENT_CERT"
	EnvNATSClientKey     = "OBSTOR_NOTIFY_NATS_CLIENT_KEY"

	// Streaming constants
	EnvNATSStreaming                   = "OBSTOR_NOTIFY_NATS_STREAMING"
	EnvNATSStreamingClusterID          = "OBSTOR_NOTIFY_NATS_STREAMING_CLUSTER_ID"
	EnvNATSStreamingAsync              = "OBSTOR_NOTIFY_NATS_STREAMING_ASYNC"
	EnvNATSStreamingMaxPubAcksInFlight = "OBSTOR_NOTIFY_NATS_STREAMING_MAX_PUB_ACKS_IN_FLIGHT"
)
...
func (n NATSArgs) connectNats() (*nats.Conn, error) {
	connOpts := []nats.Option{nats.Name("Obstor Notification")}
