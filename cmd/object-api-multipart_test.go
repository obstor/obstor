...
func testObjectNewMultipartUpload(obj ObjectLayer, instanceType string, t TestErrHandler) {
	...
	errMsg := "Bucket not found: obstor-bucket"
...
func testObjectAPIPutObjectPart(obj ObjectLayer, instanceType string, t TestErrHandler) {
	...
	testCases := []struct {
		...
		{bucket, "", "", 1, "", "", "", 0, false, "", fmt.Errorf("%s", "Object name invalid: obstor-bucket/")},
		// Test case - 6.
...
func testListMultipartUploads(obj ObjectLayer, instanceType string, t TestErrHandler) {
	...
	bucketNames := []string{"obstor-bucket", "obstor-2-bucket", "obstor-3-bucket"}
	objectNames := []string{"obstor-object-1.txt", "obstor-object.txt", "neymar-1.jpeg", "neymar.jpeg", "parrot-1.png", "parrot.png"}
	uploadIDs := []string{}
	opts := ObjectOptions{}
	// bucketnames[0].
	// objectNames[0].
	...
	testCases := []struct {
		...
		{bucketNames[1], "", "obstor-object-1.txt", uploadIDs[1], "", 100, listMultipartResults[16], nil, true},
		{bucketNames[1], "", "obstor-object-1.txt", uploadIDs[2], "", 100, listMultipartResults[17], nil, true},
		...
		{bucketNames[2], "obstor-object", objectNames[1], "", "", 10, listMultipartResults[34], nil, true},
	}
...
func testListObjectPartsDiskNotFound(obj ObjectLayer, instanceType string, disks []string, t *testing.T) {
	...
	bucketNames := []string{"obstor-bucket", "obstor-2-bucket"}
	objectNames := []string{"obstor-object-1.txt"}
	uploadIDs := []string{}
