...
const (
	...
	RRSEnv = "OBSTOR_STORAGE_CLASS_RRS"
	// Standard storage class environment variable
	StandardEnv = "OBSTOR_STORAGE_CLASS_STANDARD"
	// DMA storage class environment variable
	DMAEnv = "OBSTOR_STORAGE_CLASS_DMA"
...
// If storage class is set using the env vars OBSTOR_STORAGE_CLASS_RRS and
// OBSTOR_STORAGE_CLASS_STANDARD or server config fields corresponding values are
// returned.
//
