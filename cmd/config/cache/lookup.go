...
const (
	...
	EnvCacheDrives        = "OBSTOR_CACHE_DRIVES"
	EnvCacheExclude       = "OBSTOR_CACHE_EXCLUDE"
	EnvCacheExpiry        = "OBSTOR_CACHE_EXPIRY"
	EnvCacheMaxUse        = "OBSTOR_CACHE_MAXUSE"
	EnvCacheQuota         = "OBSTOR_CACHE_QUOTA"
	EnvCacheAfter         = "OBSTOR_CACHE_AFTER"
	EnvCacheWatermarkLow  = "OBSTOR_CACHE_WATERMARK_LOW"
	EnvCacheWatermarkHigh = "OBSTOR_CACHE_WATERMARK_HIGH"
	EnvCacheRange         = "OBSTOR_CACHE_RANGE"
	EnvCacheCommit        = "OBSTOR_CACHE_COMMIT"

	EnvCacheEncryptionKey = "OBSTOR_CACHE_ENCRYPTION_SECRET_KEY"
