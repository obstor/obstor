...
const (
	...
	EnvDelay         = "OBSTOR_SCANNER_DELAY"
	EnvCycle         = "OBSTOR_SCANNER_CYCLE"
	EnvDelayLegacy   = "OBSTOR_CRAWLER_DELAY"
	EnvMaxWait       = "OBSTOR_SCANNER_MAX_WAIT"
	EnvMaxWaitLegacy = "OBSTOR_CRAWLER_MAX_WAIT"
)
