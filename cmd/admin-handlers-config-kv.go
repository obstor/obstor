...
import (
	...
	"github.com/obstor/obstor/cmd/config/etcd"
...
// DelConfigKVHandler - DELETE /obstor/admin/v3/del-config-kv
...
// SetConfigKVHandler - PUT /obstor/admin/v3/set-config-kv
...
// GetConfigKVHandler - GET /obstor/admin/v3/get-config-kv?key={key}
...
// HelpConfigKVHandler - GET /obstor/admin/v3/help-config-kv?subSys={subSys}&key={key}
...
// SetConfigHandler - PUT /obstor/admin/v3/config
...
// GetConfigHandler - GET /obstor/admin/v3/config
// Get config.json of this obstor setup.
