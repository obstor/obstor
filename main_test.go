...
//
// $ docker run -e MINT_MODE=full -e SERVER_ENDPOINT=192.168.47.11:9000 -e ACCESS_KEY=obstoradmin -e SECRET_KEY=obstoradmin -v /tmp/tests/log:/tests/log obstor/testing
//
