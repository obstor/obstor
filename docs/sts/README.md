...
> - [**AssumeRole**](/docs/sts/assume-role)
> - [**AD/LDAP**](/docs/sts/ldap)
...
> NOTE: If you are interested in AssumeRole API only, skip to [here](/docs/sts/assume-role)
