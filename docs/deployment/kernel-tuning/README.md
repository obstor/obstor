# Kernel Tuning for Obstor Production Deployment on Linux Servers

List of kernel tuning recommendations for Obstor server deployments, a copy of this [script](https://github.com/obstor/obstor/blob/main/docs/deployment/kernel-tuning/sysctl.sh) is available here that can be applied on the servers.
