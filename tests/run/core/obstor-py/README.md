## `obstor-py` tests
This directory serves as the location for Testing tests using `obstor-py`.  Top level `testing.sh` calls `run.sh` to execute tests.

## Adding new tests
New tests is added in functional tests of obstor-py.  Please check https://github.com/obstor/obstor-py
